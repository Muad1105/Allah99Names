const allahNames = [
  {
    ...
    description: [
      "ഈ നാമം 1000 തവണയെങ്കിലും ആവർത്തിച്ചാൽ അവൻ്റെ ഹൃദയം സംശയങ്ങളിൽ നിന്നും സംശയങ്ങളിൽ നിന്നും മുക്തമാകും.",
      "ഭേദമാക്കാനാവാത്ത രോഗങ്ങളാൽ ബുദ്ധിമുട്ടുന്ന ആരെങ്കിലും ഈ നാമം പല ബന്ധങ്ങളും ആവർത്തിക്കുകയാണെങ്കിൽ, സുഖം പ്രാപിക്കാൻ അല്ലാഹുവിനോട് പ്രാർത്ഥിച്ചാൽ, അല്ലാഹുവിൻ്റെ അനുഗ്രഹത്താൽ അവൻ രോഗത്തിൽ നിന്ന് മുക്തി നേടും.",
    ],
  },
  {
    nameNumber: 1,
  ...
  },
  {
    ...
    description: [
      "ഓരോ ഫജ്ർ നമസ്കാരത്തിനു ശേഷവും 100 പ്രാവശ്യം ഈ നാമം ആവർത്തിക്കുന്നയാൾ എല്ലാവരോടും അവനോട് സൗഹാർദ്ദപരമായി പെരുമാറുകയും എല്ലാ ലൗകിക വിപത്തുകളിൽ നിന്നും സുരക്ഷിതനായിരിക്കുകയും ചെയ്യും.",
    ],
  },
  {
    nameNumber: 3,
  ...
  },
  {
    ...
    meaning: "പൂർണതയും സമാധാനം നൽകുന്നവൻ",
    description: [
  ...
  },
  {
    ...
    description: [
      "ഈ നാമം 631 ബന്ധങ്ങൾ ആവർത്തിക്കുന്നവൻ അപകടത്തിൽ നിന്ന് സുരക്ഷിതനായിരിക്കും.",
    ],
  },
  {
    nameNumber: 7,
  ...
  },
  {
    ...
    description: [
      "ദാരിദ്ര്യമോ പട്ടിണിയോ മൂലം ബുദ്ധിമുട്ടുന്ന ഒരാൾ ഈ പേര് ഇടയ്ക്കിടെ ആവർത്തിക്കുകയോ ഒരു കടലാസിൽ എഴുതി സൂക്ഷിക്കുകയോ ചെയ്താൽ അല്ലെങ്കിൽ അവസാന സജ്ദയിൽ 40 തവണ ഈ പേര് ചൊല്ലിയാൽ, അല്ലാഹു അവൻ്റെ ദാരിദ്ര്യവും ദാരിദ്ര്യവും പട്ടിണിയും ഒഴിവാക്കും. ഒരു അത്ഭുതകരമായ വഴി.",
    ],
  },
  {
    nameNumber: 17,
  ...
  },
  {
    ...
    description: [
      "4 കഷണങ്ങൾ (പഴം, റൊട്ടി മുതലായവ) ഈ നാമം എഴുതി 40 ദിവസം ഭക്ഷിക്കുന്നവൻ വിശപ്പില്ല.",
    ],
  },
  {
    nameNumber: 21,
  ...
  },
  {
    ...
    meaning: "ഉയർത്തുനവൻ",
    description: [
      "ഈ നാമം പകലും രാത്രിയും 101 തവണ ആവർത്തിച്ചാൽ, അള്ളാഹു അവനെ ഉന്നതനാക്കും, ബഹുമാനവും സമ്പത്തും യോഗ്യതയും.",
    ],
  },
  {
    nameNumber: 24,
  ...
  },
  {
    ...
    description: [
      "വെള്ളിയാഴ്ച ഉച്ചകഴിഞ്ഞുള്ള പ്രാർത്ഥനയ്ക്ക് ശേഷം ഈ നാമം 100 തവണ ആവർത്തിക്കുന്നയാൾ, അള്ളാൽ ഈ വ്യക്തിക്ക് അവൻ്റെ ദൃഷ്ടിയിൽ പ്രകാശം നൽകുകയും അവൻ്റെ ഹൃദയത്തെ പ്രകാശിപ്പിക്കുകയും ചെയ്യും.",
    ],
  },
  {
    nameNumber: 28,
  ...
  },
  {
    ...
    description: [
      "തലവേദനയും പനിയും നിരാശയും ഉള്ളവനും ഈ നാമം തുടർച്ചയായി ആവർത്തിക്കുന്നവനും അസുഖം മാറുകയും അല്ലാഹുവിൻ്റെ പാപമോചനം ലഭിക്കുകയും ചെയ്യും.",
    ],
  },
  {
    nameNumber: 35,
  ...
  },
  {
    ...
    meaning: "ഉയിർത്തെഴുന്നേൽപിക്കുന്നവൻ, മരിച്ചവരെ ഉയർത്തുന്നവൻ",
  ...
  },
  {
    ...
    meaning: "ആദ്യത്തേത്",
    description: [
      "ഇത് പലതവണ ആവർത്തിക്കുന്നവൻ നല്ല ജീവിതം നയിക്കുകയും ഈ ജീവിതാവസാനം നല്ല മരണവും നേടുകയും ചെയ്യും.",
    ],
  },
  {
    nameNumber: 74,
  ...
  },
  {
    ...
    meaning: "പ്രകടമായത്",
    description: [
      "വെള്ളിയാഴ്ച (ജുമ്മ നമസ്കാരം) ദിവ്യപ്രകാശം (നൂർ) 15 തവണ ഈ നാമം ചൊല്ലുന്നവൻ അവൻ്റെ ഹൃദയത്തിൽ പ്രവേശിക്കും.",
    ],
  },
  {
    nameNumber: 76,
