const allahNames = [
  ...
  },
  {
    ...
    description: [
      "ഓരോ ഫജ്ർ നമസ്കാരത്തിനു ശേഷവും 100 പ്രാവശ്യം ഈ നാമം ആവർത്തിക്കുന്നയാൾ എല്ലാവരും അവനോട് സൗഹാർദ്ദപരമായി പെരുമാറുകയും എല്ലാ ലൗകിക വിപത്തുകളിൽ നിന്നും സുരക്ഷിതനായിരിക്കുകയും ചെയ്യും.",
    ],
  },
  {
    nameNumber: 3,
